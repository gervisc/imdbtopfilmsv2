...
class Movie(Base):
    ...
    ratingCountry1= Column(Integer, nullable=True)
    ratingCountry2 = Column(Integer, nullable=True)
    ratingCountry3 = Column(Integer, nullable=True)
    ratingCountry4 = Column(Integer, nullable=True)
    ratingCountry5 = Column(Integer, nullable=True)
    ratingCountry1Votes = Column(Float, nullable=True)
    ratingCountry2Votes= Column(Float, nullable=True)
